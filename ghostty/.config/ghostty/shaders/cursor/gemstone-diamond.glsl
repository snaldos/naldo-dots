// BUILD: standalone gemstone-diamond cursor
// Derived from combined/gemstone-diamond.glsl; mainImage never renders its background.
...
#define GD_ENABLE_RESONANCE_LINK 0    // standalone cursor: no links to invisible objects
