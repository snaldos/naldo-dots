// BUILD: standalone lorenz-constellation cursor
// Derived from combined/lorenz-constellation.glsl; mainImage never renders its background.
...
#define LC_ENABLE_RESONANCE_LINK 0    // standalone cursor: no links to invisible objects
