// BUILD: standalone torus-knot-covenant cursor
// Derived from combined/torus-knot-covenant.glsl; mainImage never renders its background.
...
#define KC_ENABLE_RESONANCE_LINK 0    // standalone cursor: no links to invisible objects
