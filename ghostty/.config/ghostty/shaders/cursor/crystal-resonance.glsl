// BUILD: standalone crystal-resonance cursor
// Derived from combined/crystal-resonance.glsl; mainImage never renders its background.
...
#define CR_ENABLE_RESONANCE_LINK 0    // standalone cursor: no links to invisible objects
