// BUILD: standalone tesseract-cube cursor
// Derived from combined/tesseract-cube.glsl; mainImage never renders its background.
...
#define TC_ENABLE_RESONANCE_LINK 0    // standalone cursor: no links to invisible objects
