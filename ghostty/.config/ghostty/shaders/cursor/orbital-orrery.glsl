// BUILD: standalone orbital-orrery cursor
// Derived from combined/orbital-orrery.glsl; mainImage never renders its background.
...
#define OC_ENABLE_RESONANCE_LINK 0    // standalone cursor: no links to invisible objects
