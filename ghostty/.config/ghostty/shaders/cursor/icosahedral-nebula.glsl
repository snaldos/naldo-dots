// BUILD: standalone icosahedral-nebula cursor
// Derived from combined/icosahedral-nebula.glsl; mainImage never renders its background.
...
#define IC_ENABLE_RESONANCE_LINK 0    // standalone cursor: no links to invisible objects
