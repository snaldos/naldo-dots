...
- Preserve Fedora's session-native SSH agents: GCR for Niri/GNOME and OpenSSH for Plasma. Plasma key loading is deliberately manual with `ssh-add`; do not add a key-loading autostart, socket override, or compatibility layer.
